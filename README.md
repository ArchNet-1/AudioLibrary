...
<p align="center">
  ...
  <h3 align="center">Library Audio</h3>
</p>
...
This a scriptable object who manage and store AudioCLip with an enum or an int.
...
in Unity : Windows -> Package Manager -> + -> Add package from git url
2. Clone the repo
3. In the project windows : Create / ArchNet / Library / AudioLibrary.
5. When given in serialized field in controller script, you can access to :
- GetAudio ( return AudioCLip from an int)
